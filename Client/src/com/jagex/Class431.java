...
public class Class431 {
   public static final int anInt4818 = 5;
   public static final int anInt4819 = 15;
   public static final int anInt4820 = 18;
   public static final int anInt4821 = 16;
   public static final int anInt4822 = 7;
   public static final int anInt4823 = 12;
   public static final int anInt4824 = 14;
   public static final int anInt4825 = 0;
   public static final int anInt4826 = 8;
   public static final int anInt4827 = 10;
   public static final int anInt4828 = 6;
   public static final int anInt4829 = 9;
   public static final int anInt4830 = 1;
   public static final int anInt4831 = 4;
   public static final int anInt4832 = 17;
   public static final int anInt4833 = 19;
   public static final int anInt4834 = 2;
   public static final int anInt4835 = 13;
   public static final int anInt4836 = 11;
   ...
   static final void method5062(Class681 var0, int var1) {
      int var2 = var0.anIntArray8622[(var0.anInt8623 -= -1957887669) * -1730576285];
      InterfaceDef var3 = Class221.method3095(var2, (byte)-34);
      Class243 var4 = Class315_Sub1.aClass243Array10033[var2 >> 16];
      Class152.method1763(var3, var4, var0, 866316862);
   }

   public static int method5063(int var0) {
      if(0 == Class425.anInt4796 * -833865599) {
         Class58.aClass58_693.method1024(new Class427("jaclib"), (byte)2);
         if(Class58.aClass58_693.method1025(271748966).method56(-2104950659) != 100) {
            return 1;
         }

         if(!((Class427)Class58.aClass58_693.method1025(-417579698)).method5025((byte)117) && !Class652.method7783(428884743)) {
            try {
               Class636.aclient8310.method5969(-1730576285);
               Class209.method2938(1467474485);
               Ping.init();
            } catch (Exception_Sub7 var9) {
               Class157.method1862(Class65.aClass65_747, var9.aString11379, var9.anInt11378 * 44688167, var9.getCause(), (byte)18);
            } catch (Throwable var10) {
               ;
            }
         }

         Class425.anInt4796 = 1342965633;
      }

      int var2;
      int var4;
      int var7;
      if(1 == -833865599 * Class425.anInt4796) {
         Class425.aClass58Array4797 = Class58.method1021(-536182098);
         ...
         Class427 var1 = new Class427("jagdx");
         if(!Class222.aString2308.startsWith("win")) {
            var1.method5026(-244474801);
         }

         Class58.aClass58_720.method1024(var1, (byte)2);
         ...
         for(var2 = 0; var2 < Class425.aClass58Array4797.length; ++var2) {
            if(Class425.aClass58Array4797[var2].method1025(754841426) == null) {
               throw new RuntimeException();
            }
         }

         var2 = 0;
         Class58[] var3 = Class425.aClass58Array4797;

         for(var4 = 0; var4 < var3.length; ++var4) {
            Class58 var5 = var3[var4];
            int var6 = var5.method1019(-1626329868);
            var7 = var5.method1025(1372025285).method56(-798960034);
            var2 += var7 * var6 / 100;
         }

         Class425.anInt4795 = -812499343 * var2;
         Class425.anInt4796 = -1609036030;
      }

      if(null == Class425.aClass58Array4797) {
         return 100;
      } else {
         int var11 = 0;
         var2 = 0;
         boolean var12 = true;
         Class58[] var13 = Class425.aClass58Array4797;

         for(int var14 = 0; var14 < var13.length; ++var14) {
            Class58 var15 = var13[var14];
            var7 = var15.method1019(-1136358384);
            int var8 = var15.method1025(516556385).method56(1286718636);
            if(var8 < 100) {
               var12 = false;
            }
         ...
         if(var12) {
            Class425.aClass58Array4797 = null;
         }

         var2 -= 652853905 * Class425.anInt4795;
         var11 -= 652853905 * Class425.anInt4795;
         var4 = var11 > 0?100 * var2 / var11:100;
         if(!var12 && var4 > 99) {
            var4 = 99;
         }
   ...
   public static String method5064(RSByteBuffer var0, int var1) {
      return Class526_Sub21_Sub6.method10574(var0, 32767, 1049793714);
   }
}
