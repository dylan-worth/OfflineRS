...
public class Class704 {
   ...
   public static void method8265(RSByteBuffer var0, int var1, byte var2) {
      ...
      var3.anInt10800 = var0.readInt() * 613169825;
   ...
   static final void decodePlayerUpdateFlags(Buffer var0, int var1, Class639_Sub1_Sub2_Sub1_Sub1 player, int var3, int var4) {
      ...
      if((var3 & 4096) != 0) {
         ...
         var14 = var0.readUnsignedByte128();
         var8 = var14 & 7;
         var9 = var14 >> 3 & 15;
         if(var9 == 15) {
            var9 = -1;
      ...
      if((var3 & 8388608) != 0) {
         player.aBool12184 = var0.readByteC() == 1;
      }
      ...
      if((var3 & 4) != 0) {
         ...
         var14 = var0.readUnsigned128Byte();
         var8 = var14 & 7;
         var9 = var14 >> 3 & 15;
         if(15 == var9) {
            var9 = -1;
      ...
      if(0 != (var3 & 512)) {
         ...
         for(var9 = 0; var9 < var5; ++var9) {
            var6[var9] = var0.readBigSmart();
            var7[var9] = var0.readUnsigned128Byte();
            var19[var9] = var0.readUnsignedShort();
         }
      ...
      if((var3 & 1048576) != 0) {
         player.aByte11928 = var0.readByte();
         player.aByte11929 = var0.readByteC(-2087725885);
         player.aByte11899 = var0.readByte();
         player.aByte11893 = (byte)var0.readUnsignedByte128();
         player.anInt11926 = (client.anInt11012 + var0.readUnsignedShort()) * -1462749463;
         player.anInt11933 = (client.anInt11012 + var0.readUnsignedShort()) * 1238611391;
      }
      ...
      if((var3 & 1024) != 0) {
         player.aClass215_12182 = (Class215)Class561.findIdentifiable(Class215.method2963(374413013), var0.readUnsigned128Byte(), (byte)-27);
      ...
      if(0 != (var3 & 2)) { //FORCE MOVEMENT
         ...
         player.anInt11912 = var0.readByte() * -1923326237;
         player.anInt11919 = var0.read128Byte() * 1573028629;
         player.anInt11920 = var0.readByte() * -1475013205;
         player.anInt11954 = var0.readByte() * 193059349;
         player.anInt11921 = var0.readByte() * -1199325289;
      ...
      if((var3 & 4194304) != 0) {
         ...
         var13 = var0.readUnsignedByte128();
         if(0 != (var13 & 1)) {
      ...
      if((var3 & 1) != 0) {
         ...
         var13 = var0.readUnsigned128Byte();
         if(var13 > 0) {
