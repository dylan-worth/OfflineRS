...
public class Class11 implements Interface12 {
   ...
   void method581(RSByteBuffer var1, int var2) {
      if(var2 == 1) {
         this.anInt75 = var1.readBigSmart() * 354238193;
      } else if(2 == var2) {
         this.aString76 = var1.readString(-1702998095);
      } else if(var2 == 4) {
         this.anInt84 = var1.readUnsignedShort() * 209442157;
      } else if(var2 == 5) {
         this.anInt90 = var1.readUnsignedShort() * 327768319;
      } else if(var2 == 6) {
         this.anInt71 = var1.readUnsignedShort() * -271953827;
      } else if(7 == var2) {
         this.anInt141 = var1.readUnsignedShort() * 524537267;
         if(56338811 * this.anInt141 > 32767) {
            this.anInt141 -= -843907072;
         }
      } else if(8 == var2) {
         this.anInt121 = var1.readUnsignedShort() * 32891111;
         ...
         this.anInt92 = var1.readInt() * -2035738291;
      } else if(13 == var2) {
         ...
         this.anInt91 = var1.readUnsignedShort() * 820694759;
      } else if(23 == var2) {
         this.anInt101 = var1.readBigSmart() * 482404415;
      } else if(24 == var2) {
         this.anInt107 = var1.readBigSmart() * 619497493;
      } else if(var2 == 25) {
         this.anInt103 = var1.readBigSmart() * 821317443;
      } else if(26 == var2) {
         this.anInt104 = var1.readBigSmart() * -1399077843;
      } else if(var2 == 27) {
         ...
         if(40 == var2) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.aShortArray77[var4] = (short)var1.readUnsignedShort();
               this.aShortArray78[var4] = (short)var1.readUnsignedShort();
            }
         } else if(var2 == 41) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.aShortArray80[var4] = (short)var1.readUnsignedShort();
               this.aShortArray85[var4] = (short)var1.readUnsignedShort();
            }
         } else if(var2 == 42) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.aByteArray79[var4] = var1.readByte();
            }
         } else if(var2 == 43) {
            this.anInt117 = var1.readInt() * 2128092929;
            this.aBool140 = true;
         } else {
            int var5;
            int var6;
            ...
            if(var2 == 44) {
               ...
               this.anInt105 = var1.readBigSmart() * 431197469;
            } else if(var2 == 79) {
               this.anInt106 = var1.readBigSmart() * -1920753693;
            } else if(var2 == 90) {
               this.anInt113 = var1.readBigSmart() * 374413013;
            } else if(var2 == 91) {
               this.anInt115 = var1.readBigSmart() * -1576879767;
            } else if(var2 == 92) {
               this.anInt81 = var1.readBigSmart() * 1760763529;
            } else if(93 == var2) {
               this.anInt97 = var1.readBigSmart() * 323846809;
            } else if(var2 == 94) {
               this.anInt95 = var1.readUnsignedShort() * -1562389847;
            } else if(95 == var2) {
               this.anInt87 = var1.readUnsignedShort() * -73963663;
            } else if(96 == var2) {
               this.anInt138 = var1.readUnsignedByte(-986608095) * 30170199;
            } else if(var2 == 97) {
               this.anInt120 = var1.readUnsignedShort() * -1476473693;
            } else if(var2 == 98) {
               this.anInt86 = var1.readUnsignedShort() * 1993936959;
               ...
               this.anIntArray119[var2 - 100] = var1.readUnsignedShort();
               this.anIntArray118[var2 - 100] = var1.readUnsignedShort();
            } else if(var2 == 110) {
               this.anInt109 = var1.readUnsignedShort() * 1988055651;
            } else if(var2 == 111) {
               this.anInt128 = var1.readUnsignedShort() * 1288900653;
            } else if(var2 == 112) {
               this.anInt129 = var1.readUnsignedShort() * 994320909;
            } else if(var2 == 113) {
               this.anInt130 = var1.readByte() * 1360175599;
            } else if(var2 == 114) {
               this.anInt131 = var1.readByte() * 1832859519;
            } else if(var2 == 115) {
               this.anInt132 = var1.readUnsignedByte(-1627404198) * -1124257223;
            } else if(121 == var2) {
               this.anInt134 = var1.readUnsignedShort() * -878791725;
            } else if(var2 == 122) {
               this.anInt122 = var1.readUnsignedShort() * 209975231;
            } else if(125 == var2) {
               this.anInt74 = (var1.readByte() << 2) * 17091139;
               this.anInt102 = (var1.readByte() << 2) * -1543586929;
               this.anInt111 = (var1.readByte() << 2) * 66946685;
            } else if(var2 == 126) {
               this.anInt127 = (var1.readByte() << 2) * 1289699803;
               this.anInt110 = (var1.readByte() << 2) * -911827491;
               this.anInt112 = (var1.readByte() << 2) * -1414814919;
               ...
               if(132 == var2) {
                  ...
                  for(var4 = 0; var4 < var3; ++var4) {
                     this.anIntArray136[var4] = var1.readUnsignedShort();
                  }
               } else if(134 == var2) {
                  this.anInt137 = var1.readUnsignedByte(701782230) * -10839459;
               } else if(var2 == 139) {
                  this.anInt114 = var1.readUnsignedShort() * 733486543;
               } else if(140 == var2) {
                  this.anInt88 = var1.readUnsignedShort() * -1666050441;
                  ...
                  this.anIntArray96[var2 - 142] = var1.readUnsignedShort();
                  ...
                  this.anIntArray65[var2 - 150] = var1.readUnsignedShort();
               } else if(156 != var2) {
                  if(157 == var2) {
                     this.aBool142 = true;
                  } else if(var2 == 161) {
                     this.anInt123 = var1.readUnsignedShort() * 2099320245;
                  } else if(var2 == 162) {
                     this.anInt124 = var1.readUnsignedShort() * -512248935;
                  } else if(var2 == 163) {
                     this.anInt126 = var1.readUnsignedShort() * -1868400551;
                  } else if(164 == var2) {
      ...
      if(var2 == 1) {
         ...
         if(40 == var2) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.aShortArray77[var5] = (short)var1.readUnsignedShort();
               this.aShortArray78[var5] = (short)var1.readUnsignedShort();
            }
         } else if(var2 == 41) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.aShortArray80[var5] = (short)var1.readUnsignedShort();
               this.aShortArray85[var5] = (short)var1.readUnsignedShort();
            }
         } else if(var2 == 42) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.aByteArray79[var5] = var1.readByte();
            }
         } else if(var2 == 43) {
            this.anInt117 = var1.readInt() * 2128092929;
            this.aBool140 = true;
            ...
            if(var2 == 44) {
               ...
               if(132 == var2) {
                  ...
                  for(var5 = 0; var5 < var4; ++var5) {
                     this.anIntArray136[var5] = var1.readUnsignedShort();
                  }
               } else if(134 == var2) {
