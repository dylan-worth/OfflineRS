...
public class Class502 {
   ...
   static Class19 method6025(Class11 var0, RSByteBuffer var1, int var2, int var3) {
      ...
      if(var6) {
         if(var2 <= 1) {
            var4.anIntArray186[0] = var1.readUnsignedShort();
            var4.anIntArray189[0] = var1.readUnsignedShort();
         } else {
            var4.anIntArray186[0] = var1.readBigSmart();
            var4.anIntArray189[0] = var1.readBigSmart();
         }

         if(-1 != -354629827 * var0.anInt107 || -1 != -2120012891 * var0.anInt104) {
            if(var2 <= 1) {
               var4.anIntArray186[1] = var1.readUnsignedShort();
               var4.anIntArray189[1] = var1.readUnsignedShort();
            } else {
               var4.anIntArray186[1] = var1.readBigSmart();
               var4.anIntArray189[1] = var1.readBigSmart();
            }
         }

         if(-1 != var0.anInt105 * -1541563083 || -1 != -490299957 * var0.anInt106) {
            if(var2 <= 1) {
               var4.anIntArray186[2] = var1.readUnsignedShort();
               var4.anIntArray189[2] = var1.readUnsignedShort();
            } else {
               var4.anIntArray186[2] = var1.readBigSmart();
               var4.anIntArray189[2] = var1.readBigSmart();
            }
         }
      }
      ...
      if(var7) {
         if(var2 <= 1) {
            var4.anIntArray191[0] = var1.readUnsignedShort();
            var4.anIntArray194[0] = var1.readUnsignedShort();
         } else {
            var4.anIntArray191[0] = var1.readBigSmart();
            var4.anIntArray194[0] = var1.readBigSmart();
         }

         if(2061744057 * var0.anInt81 != -1 || -1 != 1299296681 * var0.anInt97) {
            if(var2 <= 1) {
               var4.anIntArray191[1] = var1.readUnsignedShort();
               var4.anIntArray194[1] = var1.readUnsignedShort();
            } else {
               var4.anIntArray191[1] = var1.readBigSmart();
               var4.anIntArray194[1] = var1.readBigSmart();
            }
         }
      }
      ...
      if(var8) {
         ...
         for(var12 = 0; var12 < 4; ++var12) {
            if(15 != var11[var12]) {
               var4.aShortArray195[var11[var12]] = (short)var1.readUnsignedShort();
            }
         }
      }
      ...
      if(var9) {
         ...
         for(var12 = 0; var12 < 2; ++var12) {
            if(15 != var11[var12]) {
               var4.aShortArray196[var11[var12]] = (short)var1.readUnsignedShort();
            }
         }
      }
