         ...
         while(true) {
            ...
            if(var4 == 1) {
               ...
               for(var5 = 0; var5 < this.anIntArray8073.length; ++var5) {
                  this.anIntArray8073[var5] = var1.readShort();
                  this.anIntArray8031[var5] = var1.readShort();
               }

               var3 = true;
            } else if(var4 == 2) {
               this.anInt8052 = var1.readBigSmart() * 131072037;
            } else if(var4 == 3) {
               ...
               if(var4 == 7) {
                  ...
                  this.anInt8028 = var1.readUnsignedShort() * -1041039597;
                  this.anInt8054 = var1.readUnsignedShort() * -662935109;
               } else if(var4 == 13) {
                  ...
                  this.anInt8056 = var1.readInt() * 1964303423;
               } else if(18 == var4) {
                  this.anInt8057 = var1.readInt() * 517986783;
               } else if(var4 == 19) {
                  this.anInt8049 = var1.readInt() * -1619164641;
               } else if(20 == var4) {
                  this.aShort8042 = (short)var1.readUnsignedShort();
                  this.aByte8060 = (byte)var1.readUnsignedByte(826901196);
               } else if(var4 == 21) {
                  this.anInt8062 = var1.readUnsignedByte(-1773237171) * 1694294211;
               } else if(var4 == 22) {
                  this.anInt8059 = var1.readBigSmart() * -2095054845;
                  this.anInt8046 = var1.readBigSmart() * 1903790841;
                  this.anInt8061 = var1.readBigSmart() * 921719221;
                  this.anInt8045 = var1.readBigSmart() * -745589619;
                  this.anInt8063 = var1.readBigSmart() * -139082727;
                  this.anInt8064 = var1.readBigSmart() * 449180193;
                  this.anInt8036 = var1.readByte() * -1531517411;
                  this.anInt8066 = var1.readByte() * -421053479;
                  this.anInt8050 = var1.readBigSmart() * -1091114509;
                  this.anInt8068 = var1.readBigSmart() * 1026815821;
                  this.anInt8069 = var1.readBigSmart() * -1154264647;
                  this.anInt8070 = var1.readBigSmart() * 1705989461;
                  this.anInt8071 = var1.readBigSmart() * -238865543;
                  this.anInt8072 = var1.readBigSmart() * 299448613;
                  this.anInt8048 = var1.readBigSmart() * -2137896873;
               } else if(23 == var4) {
      ...
      while(true) {
         while(true) {
            ...
            if(var3 == 1) {
               ...
               for(var4 = 0; var4 < this.anIntArray8073.length; ++var4) {
                  this.anIntArray8073[var4] = var1.readShort();
                  this.anIntArray8031[var4] = var1.readShort();
               }
