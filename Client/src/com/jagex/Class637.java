...
public class Class637 {
   ...
   public boolean method7569(RSByteBuffer var1, int var2) {
      ...
      if(var3 == 0) {
         this.anInt8314 = var1.readUnsignedShort() * 1831964627;
         return false;
      } else {
         if((var3 & 342550689 * Class658.aClass658_8505.anInt8507) != 0) {
            this.anInt8326 = var1.readInt() * -1446596901;
         }
         ...
         if((var3 & 342550689 * Class658.aClass658_8497.anInt8507) != 0) {
            this.anInt8329 = var1.readInt() * 2028036427;
         }

         if(0 != (var3 & 342550689 * Class658.aClass658_8498.anInt8507)) {
            this.anInt8316 = var1.readUnsignedShort() * -1078026219;
         }

         if(0 != (var3 & 342550689 * Class658.aClass658_8503.anInt8507)) {
            this.anInt8321 = var1.readUnsignedShort() * -2119764079;
         }
         ...
         if(0 != (var3 & Class658.aClass658_8499.anInt8507 * 342550689)) {
            this.anInt8322 = var1.readUnsignedShort() * -183947903;
            this.anInt8311 = var1.readShort() * 240060281;
            this.anInt8324 = var1.readShort() * 1781474553;
            this.anInt8325 = var1.readShort() * 66062039;
            this.anInt8317 = var1.readUnsignedShort() * 121415465;
         }

         if(0 != (var3 & Class658.aClass658_8492.anInt8507 * 342550689)) {
            this.anIntArray8327[0] = var1.readUnsignedShort();
            this.aFloatArray8328[0] = var1.method9634((byte)1);
         }

         if((var3 & 342550689 * Class658.aClass658_8504.anInt8507) != 0) {
            this.anIntArray8327[1] = var1.readUnsignedShort();
            this.aFloatArray8328[1] = var1.method9634((byte)1);
         }

         if((var3 & 342550689 * Class658.aClass658_8506.anInt8507) != 0) {
            this.anIntArray8327[2] = var1.readUnsignedShort();
