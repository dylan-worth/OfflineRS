      ...
      if(var2 == 1) {
         ...
         for(int var5 = var1.readUnsignedByte(649721904); var5 != 255; var5 = var1.readUnsignedByte(2113972846)) {
            ...
            for(int var9 = 0; var9 < var8.length; ++var9) {
               var8[var9] = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-104);
            }
      ...
      if(var2 == 1) {
         ...
         for(int var4 = var1.readUnsignedByte(2047743316); var4 != 255; var4 = var1.readUnsignedByte(-363191077)) {
            ...
            for(int var8 = 0; var8 < var7.length; ++var8) {
               var7[var8] = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-57);
            }
