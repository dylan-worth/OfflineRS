...
public class GameMap {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         if(null != this.aByteArrayArray5687[var3]) {
            ...
            while(var18.pos * 301018015 < this.aByteArrayArray5687[var3].length && var6 < 511 && client.npcCount * 1139938345 < 1023) {
               ...
               int var8 = var18.readUnsignedShort();
               int var9 = var8 >> 14;
               int var10 = var8 >> 7 & 63;
               int var11 = var8 & 63;
               ...
               NPCDef var14 = (NPCDef)Class76.loader.method89(var18.readUnsignedShort(), -1173238490);
   ...
   void method6099(Buffer buffer, short var2) {
      int centerX = buffer.readUnsignedShort();
      int size = buffer.readUnsignedByte(1439342522);
      int count = buffer.readUnsignedByte(-1508333174);
      boolean force = buffer.readUnsigned128Byte() == 1;
      this.renderDistance = buffer.readByteC() * 2068706387;
      ...
      for(int var2 = 0; var2 < var1; ++var2) {
         if(null != this.aByteArrayArray5687[var2]) {
            ...
            while(var17.pos * 301018015 < this.aByteArrayArray5687[var2].length && var5 < 511 && client.npcCount * 1139938345 < 1023) {
               ...
               int var7 = var17.readUnsignedShort();
               int var8 = var7 >> 14;
               int var9 = var7 >> 7 & 63;
               int var10 = var7 & 63;
               ...
               NPCDef var13 = (NPCDef)Class76.loader.method89(var17.readUnsignedShort(), -1808258973);
