...
public class Class199_Sub18 extends Class199 {
   ...
   Class199_Sub18(RSByteBuffer var1, int var2, int var3) {
      ...
      if(var2 == 0) {
         ...
         this.anInt9952 = var1.readUnsignedShort() * -1637169243;
      }
      ...
      if(0 == var3) {
         ...
         this.anInt9963 = var1.readUnsignedShort() * 120490401;
      }
      ...
      this.anInt9960 = var1.readUnsignedShort() * -1914038211;
      ...
      this.anInt9954 = var1.readUnsignedShort() * -886072259;
