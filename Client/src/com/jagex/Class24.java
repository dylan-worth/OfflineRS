...
public class Class24 implements Interface12, Interface5 {
      ...
      if(var2 == 1) {
         ...
         if(var2 != 5 && var2 != 6) {
            if(7 == var2 || var2 == 8) {
               ...
               this.anInt240 = var1.readUnsignedShort() * -1840123847;
               ...
               for(var5 = 0; var5 < this.anInt240 * 2029452809; ++var5) {
                  ...
                  if(var2 == 7) {
                     ...
                     this.anObjectArray238[var8] = new Integer(var1.readInt());
                  }
               }
            } else if(var2 == 101) {
               this.aClass454_233 = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-113);
            } else if(102 == var2) {
               this.aClass454_234 = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-20);
            }
         } else {
            this.anInt240 = var1.readUnsignedShort() * -1840123847;
   ...
   void method705(RSByteBuffer var1, int var2) {
      char var3;
      if(var2 == 1) {
         var3 = Class69.method1087(var1.readByte(), (short)10763);
         this.aClass454_233 = Class454.method5388(var3, -1452597781);
      } else if(2 == var2) {
         var3 = Class69.method1087(var1.readByte(), (short)7519);
            ...
            if(7 == var2 || var2 == 8) {
               ...
               for(var4 = 0; var4 < this.anInt240 * 2029452809; ++var4) {
                  ...
                  if(var2 == 7) {
                     ...
                     this.anObjectArray238[var7] = new Integer(var1.readInt());
                  }
               }
            } else if(var2 == 101) {
               this.aClass454_233 = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-62);
            } else if(102 == var2) {
               this.aClass454_234 = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-16);
            }
         } else {
            this.anInt240 = var1.readUnsignedShort() * -1840123847;
            this.aMap237 = new HashMap(this.anInt240 * 2029452809);
   ...
   void method707(RSByteBuffer var1, int var2) {
      char var3;
      if(var2 == 1) {
         var3 = Class69.method1087(var1.readByte(), (short)2004);
         this.aClass454_233 = Class454.method5388(var3, -1968449476);
      } else if(2 == var2) {
         var3 = Class69.method1087(var1.readByte(), (short)14867);
         ...
         if(var2 != 5 && var2 != 6) {
            if(7 == var2 || var2 == 8) {
               ...
               this.aClass454_233 = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-126);
            } else if(102 == var2) {
               this.aClass454_234 = (Class454)Class561.findIdentifiable(Class454.method5391(1508098173), var1.readSmart(), (byte)-56);
            }
         } else {
            this.anInt240 = var1.readUnsignedShort() * -1840123847;
            this.aMap237 = new HashMap(this.anInt240 * 2029452809);
