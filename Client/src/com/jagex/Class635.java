...
public class Class635 {
   ...
   void method7550(RSByteBuffer var1, byte var2) {
      while(true) {
         ...
         if(1 == var3) {
            this.anInt8289 = var1.readInt() * -865284593;
         } else if(2 == var3) {
            this.anInt8290 = var1.readInt() * -2101861615;
         } else if(var3 == 3) {
            this.anInt8291 = var1.readInt() * -1137497787;
         } else if(4 == var3) {
            this.anInt8292 = var1.readUnsignedByte(1005431081) * -614246189;
         } else if(var3 == 5) {
            this.anInt8279 = var1.readUnsignedByte(1581835160) * -1499048369;
         } else if(var3 == 6) {
            this.anInt8287 = var1.readInt() * 1664056203;
         } else if(var3 == 7) {
            this.anInt8295 = var1.readInt() * 2125037133;
         } else if(var3 >= 100) {
            var3 -= 100;
            this.anIntArrayArray8296[var3 & (int)(Math.pow(2.0D, 3.0D) - 1.0D)][var3 >> 3] = var1.readUnsignedShort();
         }
      }
   }
   ...
   void method7551(RSByteBuffer var1) {
      while(true) {
         ...
         if(1 == var2) {
            ...
            var2 -= 100;
            this.anIntArrayArray8296[var2 & (int)(Math.pow(2.0D, 3.0D) - 1.0D)][var2 >> 3] = var1.readUnsignedShort();
         }
      }
   }
