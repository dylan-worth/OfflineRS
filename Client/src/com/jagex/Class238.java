...
public class Class238 implements Interface12 {
   ...
   void method3288(RSByteBuffer var1, int var2) {
      if(var2 == 1) {
         this.anInt2400 = var1.readBigSmart() * 129155123;
      } else if(2 == var2) {
         this.anInt2417 = var1.readBigSmart() * -1494519377;
      } else if(3 == var2) {
         ...
         if(7 == var2) {
            ...
            this.anInt2418 = var1.readUnsignedShort() * 1930534875;
            if(-160873389 * this.anInt2418 == '\uffff') {
               this.anInt2418 = -1930534875;
            }

            this.anInt2419 = var1.readUnsignedShort() * -1193048497;
            if(2088358063 * this.anInt2419 == '\uffff') {
               this.anInt2419 = 1193048497;
            }

            this.anInt2430 = var1.readInt() * 861372443;
            this.anInt2416 = var1.readInt() * 1855903673;
            ...
            if(15 == var2) {
               ...
               this.anInt2415 = var1.readBigSmart() * 1271559689;
            } else if(var2 == 19) {
               this.anInt2442 = var1.readUnsignedShort() * -1193811099;
            } else if(var2 == 20) {
               this.anInt2422 = var1.readUnsignedShort() * -564279077;
               if(282129235 * this.anInt2422 == '\uffff') {
                  this.anInt2422 = 564279077;
               }

               this.anInt2423 = var1.readUnsignedShort() * -407014271;
               if(this.anInt2423 * 858180481 == '\uffff') {
                  this.anInt2423 = 407014271;
               }

               this.anInt2420 = var1.readInt() * 1532440867;
               this.anInt2421 = var1.readInt() * 1860754503;
            } else if(21 == var2) {
               this.anInt2428 = var1.readInt() * -633551287;
            } else if(22 == var2) {
               this.anInt2397 = var1.readInt() * -2125543481;
            } else if(var2 == 23) {
               ...
               this.anInt2409 = var1.readShort() * 1849679449;
               this.anInt2437 = var1.readShort() * -1985370405;
            } else if(25 == var2) {
               this.anInt2444 = var1.readBigSmart() * 1865687979;
               ...
               for(var5 = 0; var5 <= var4; ++var5) {
                  this.anIntArray2424[var5] = var1.readUnsignedShort();
         ...
         if(7 == var2) {
            ...
            if(15 == var2) {
               ...
               for(var5 = 0; var5 < var4 * 2; ++var5) {
                  this.anIntArray2432[var5] = var1.readShort();
               }
               ...
               for(var6 = 0; var6 < this.anIntArray2438.length; ++var6) {
                  this.anIntArray2438[var6] = var1.readInt();
               }

               this.aByteArray2439 = new byte[var4];

               for(var6 = 0; var6 < var4; ++var6) {
                  this.aByteArray2439[var6] = var1.readByte();
               }
            } else if(var2 == 16) {
               this.aBool2434 = false;
            } else if(var2 == 17) {
               ...
               for(var6 = 0; var6 <= var5; ++var6) {
                  this.anIntArray2424[var6] = var1.readUnsignedShort();
