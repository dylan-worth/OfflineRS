...
public class Class170 {
   ...
   public Class170(byte[] var1) {
      ...
      if(var9 != 1) {
         ...
         this.anInt1918 = var2.readUnsignedShort();
         this.anInt1929 = var2.readUnsignedShort();
         this.anInt1947 = var2.readUnsignedShort();
         ...
         int var25 = var2.readUnsignedShort();
         int var26 = var2.readUnsignedShort();
         int var27 = var2.readUnsignedShort();
         int var28 = var2.readUnsignedShort();
         int var29 = var2.readUnsignedShort();
         if(!var14) {
            if(var22 == 1) {
         ...
         if(this.anInt1947 > 0) {
            ...
            for(var33 = 0; var33 < this.anInt1947; ++var33) {
               byte var34 = this.aByteArray1948[var33] = var2.readByte();
               if(var34 == 0) {
                  ++var30;
               }
         ...
         for(var63 = 0; var63 < this.anInt1918; ++var63) {
            ...
            var65 = 0;
            if((var64 & 1) != 0) {
               var65 = var3.readUnsignedSmart();
            }

            var66 = 0;
            if((var64 & 2) != 0) {
               var66 = var4.readUnsignedSmart();
            }

            var67 = 0;
            if((var64 & 4) != 0) {
               var67 = var5.readUnsignedSmart();
            }
            ...
            if(var22 == 1) {
               if(var14) {
                  this.anIntArray1924[var63] = var6.readDecoratedSmart();
               } else {
         ...
         if(this.anInt1951 > 0) {
            ...
            for(var63 = 0; var63 < this.anInt1951; ++var63) {
               this.aFloatArray1914[var63] = (float)var3.readShort() / 4096.0F;
               this.aFloatArray1928[var63] = (float)var4.readShort() / 4096.0F;
            }
         }
         ...
         for(var63 = 0; var63 < this.anInt1929; ++var63) {
            this.aShortArray1940[var63] = (short)var2.readUnsignedShort();
            if(var11) {
               this.aByteArray1936[var63] = var3.readByte();
            }

            if(var18 == 255) {
               this.aByteArray1937[var63] = var4.readByte();
            }

            if(var19 == 1) {
               this.aByteArray1938[var63] = var5.readByte();
            }

            if(var20 == 1) {
               if(var15) {
                  this.anIntArray1949[var63] = var6.readDecoratedSmart();
               } else {
            ...
            if(var21 == 1) {
               this.aShortArray1941[var63] = (short)(var7.readUnsignedShort() - 1);
            }

            if(this.aShortArray1943 != null) {
               if(this.aShortArray1941[var63] != -1) {
                  if(this.anInt1942 >= 16) {
                     this.aShortArray1943[var63] = (short)(var8.readSmart() - 1);
                  } else {
         ...
         if(var12) {
            ...
            if(var63 > 0) {
               ...
               for(var64 = 0; var64 < var63; ++var64) {
                  var65 = var2.readUnsignedShort();
                  var66 = var2.readUnsignedShort();
                  byte var71;
                  if(var18 == 255) {
   ...
   void method2131(RSByteBuffer var1, RSByteBuffer var2, RSByteBuffer var3) {
      ...
      for(int var8 = 0; var8 < this.anInt1929; ++var8) {
         ...
         int var10 = var9 & 7;
         if(var10 == 1) {
            this.aShortArray1930[var8] = var4 = (short)(var1.readUnsignedSmart() + var7);
            this.aShortArray1931[var8] = var5 = (short)(var1.readUnsignedSmart() + var4);
            this.aShortArray1932[var8] = var6 = (short)(var1.readUnsignedSmart() + var5);
            var7 = var6;
   ...
   void method2132(RSByteBuffer var1, RSByteBuffer var2, RSByteBuffer var3, RSByteBuffer var4, RSByteBuffer var5, RSByteBuffer var6) {
      for(int var7 = 0; var7 < this.anInt1947; ++var7) {
         ...
         if(var8 == 0) {
            this.aShortArray1944[var7] = (short)var1.readUnsignedShort();
            this.aShortArray1927[var7] = (short)var1.readUnsignedShort();
            this.aShortArray1953[var7] = (short)var1.readUnsignedShort();
         }

         if(var8 == 1) {
            this.aShortArray1944[var7] = (short)var2.readUnsignedShort();
            this.aShortArray1927[var7] = (short)var2.readUnsignedShort();
            this.aShortArray1953[var7] = (short)var2.readUnsignedShort();
            if(this.anInt1942 < 15) {
               this.anIntArray1945[var7] = var3.readUnsignedShort();
               if(this.anInt1942 < 14) {
                  this.anIntArray1935[var7] = var3.readUnsignedShort();
               } else {
                  this.anIntArray1935[var7] = var3.read24BitInt(742041327);
               }

               this.anIntArray1954[var7] = var3.readUnsignedShort();
            } else {
            ...
            this.aByteArray1958[var7] = var4.readByte();
            this.aByteArray1959[var7] = var5.readByte();
            this.anIntArray1955[var7] = var6.readByte();
         }
         ...
         if(var8 == 2) {
            ...
            this.aByteArray1959[var7] = var5.readByte();
            this.anIntArray1955[var7] = var6.readByte();
            this.anIntArray1956[var7] = var6.readByte();
            this.anIntArray1957[var7] = var6.readByte();
         }
