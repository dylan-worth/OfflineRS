   ...
   static boolean method6285(Class174 var0, int var1, int var2, boolean var3) {
      ...
      if(anInt7085 == 0) {
         ...
         for(var7 = 0; var7 < var6; ++var7) {
            anIntArray7104[var7] = aClass526_Sub36_7140.readSmart();
         }
         ...
         for(var8 = 0; var8 < var7; ++var8) {
            anIntArray7087[var8] = aClass526_Sub36_7140.readSmart();
         }
      }
   ...
   static void method6307(Class174 var0, RSByteBuffer var1, int var2, int var3, int var4, int var5, int[] var6, int[] var7) {
      ...
      if((var8 & 1) == 0) {
         ...
         if(var9) {
            ...
            aShortArray7121[var4 + var5 * anInt7102] = (short)var1.readSmart();
         }
      } else {
         ...
         for(int var12 = 0; var12 < var21; ++var12) {
            int var13 = var1.readSmart();
            int var14 = 0;
            int var15 = 0;
            if(var22) {
               var14 = var1.readSmart();
            ...
            if(var12 == 0) {
               ...
               if(var16 == 1) {
                  anObjectArray7108[var4 + var5 * anInt7102] = new Integer(var1.readBigSmart());
                  aByteArray7114[var4 + var5 * anInt7102] = var1.readByte();
               } else if(var16 > 1) {
                  var17 = new int[var16];
                  var18 = new byte[var16];

                  for(var19 = 0; var19 < var16; ++var19) {
                     var17[var19] = var1.readBigSmart();
                     var18[var19] = var1.readByte();
                  }
