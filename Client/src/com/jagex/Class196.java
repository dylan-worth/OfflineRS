...
public class Class196 {
   ...
   Class196(RSByteBuffer var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         this.anIntArray2184[var3] = var1.readUnsignedShort() - 5120;
         this.anIntArray2190[var3] = var1.readUnsignedShort() - 5120;
         this.anIntArray2185[var3] = var1.readShort();
         this.anIntArray2188[var3] = var1.readUnsignedShort() - 5120;
         this.anIntArray2189[var3] = var1.readUnsignedShort() - 5120;
         this.anIntArray2186[var3] = var1.readShort();
         this.anIntArray2187[var3] = var1.readShort();
      }
