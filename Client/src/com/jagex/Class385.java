...
public class Class385 {
   ...
   void method4734(RSByteBuffer var1, int var2) {
      if(var2 == 1) {
         this.aShort3963 = (short)var1.readUnsignedShort();
         this.aShort3964 = (short)var1.readUnsignedShort();
         this.aShort3965 = (short)var1.readUnsignedShort();
         this.aShort3966 = (short)var1.readUnsignedShort();
         byte var3 = 3;
         ...
         this.anInt3967 = var1.readInt() * -1939532645;
         this.anInt3968 = var1.readInt() * 363550731;
      } else if(var2 == 4) {
         this.anInt3969 = var1.readUnsignedByte(1990153563) * 588073017;
         this.anInt4022 = var1.readByte() * 1760371491;
      } else if(var2 == 5) {
         this.anInt4020 = (this.anInt3974 = (var1.readUnsignedShort() << 12 << 2) * 90899425) * -1388291973;
      } else if(6 == var2) {
         this.anInt3977 = var1.readInt() * -650507995;
         this.anInt3999 = var1.readInt() * -1967445647;
      } else if(var2 == 7) {
         this.anInt4024 = var1.readUnsignedShort() * 972665181;
         this.anInt3985 = var1.readUnsignedShort() * 1537495981;
      } else if(8 == var2) {
         this.anInt3983 = var1.readUnsignedShort() * -1374595275;
         this.anInt3987 = var1.readUnsignedShort() * 264765831;
      } else {
         int var4;
         int var5;
         if(var2 == 9) {
            ...
            for(var4 = 0; var4 < var5; ++var4) {
               this.anIntArray3973[var4] = var1.readUnsignedShort();
            }
         } else if(10 == var2) {
            ...
            for(var4 = 0; var4 < var5; ++var4) {
               this.anIntArray3984[var4] = var1.readUnsignedShort();
            }
         } else if(12 == var2) {
            this.anInt4035 = var1.readByte() * -1711723309;
         } else if(var2 == 13) {
            this.anInt3994 = var1.readByte() * 1965130027;
         } else if(14 == var2) {
            this.anInt3995 = var1.readUnsignedShort() * -1172622705;
         } else if(15 == var2) {
            this.anInt3979 = var1.readUnsignedShort() * -845474187;
         } else if(16 == var2) {
            this.aBool3996 = var1.readUnsignedByte(-1142498516) == 1;
            this.anInt3998 = var1.readUnsignedShort() * -16916557;
            this.anInt4004 = var1.readUnsignedShort() * -1431288223;
            this.aBool3997 = var1.readUnsignedByte(-696854628) == 1;
         } else if(17 == var2) {
            this.anInt4002 = var1.readUnsignedShort() * 1969476791;
         } else if(18 == var2) {
            this.anInt3980 = var1.readInt() * 734778259;
         } else if(var2 == 19) {
            ...
            this.anInt3971 = var1.readInt() * 812113071;
         } else if(23 == var2) {
            ...
            for(var4 = 0; var4 < var5; ++var4) {
               this.anIntArray3989[var4] = var1.readUnsignedShort();
            }
         } else if(var2 == 26) {
            this.aBool4001 = false;
         } else if(27 == var2) {
            this.anInt3975 = (var1.readUnsignedShort() << 12 << 2) * 1257650331;
         } else if(28 == var2) {
            this.anInt4014 = var1.readUnsignedByte(1905897712) * -1117396183;
         } else if(var2 == 29) {
            if(var1.readUnsignedByte(749990228) == 0) {
               this.anInt4006 = (this.anInt4007 = var1.readShort() * 1712293512) * 183614651;
            } else {
               this.anInt4006 = var1.readShort() * -366271144;
               this.anInt4007 = var1.readShort() * 1712293512;
            }
         } else if(var2 == 30) {
            this.aBool4029 = true;
         } else if(var2 == 31) {
            this.anInt4020 = (var1.readUnsignedShort() << 12 << 2) * 1761621275;
            this.anInt3974 = (var1.readUnsignedShort() << 12 << 2) * 90899425;
         } else if(var2 == 32) {
            ...
            if(var1.readUnsignedByte(-2061544158) == 0) {
               this.anInt4003 = (this.anInt3988 = var1.readShort() * 1107956808) * -255214351;
            } else {
               this.anInt4003 = var1.readShort() * -18221112;
               this.anInt3988 = var1.readShort() * 1107956808;
      ...
      if(var2 == 1) {
         ...
         if(var2 == 9) {
            ...
            for(var5 = 0; var5 < var6; ++var5) {
               this.anIntArray3973[var5] = var1.readUnsignedShort();
            }
         } else if(10 == var2) {
            ...
            for(var5 = 0; var5 < var6; ++var5) {
               this.anIntArray3984[var5] = var1.readUnsignedShort();
            }
         } else if(12 == var2) {
            this.anInt4035 = var1.readByte() * -1711723309;
         } else if(var2 == 13) {
            ...
            for(var5 = 0; var5 < var6; ++var5) {
               this.anIntArray3989[var5] = var1.readUnsignedShort();
            }
         } else if(var2 == 26) {
            this.aBool4001 = false;
         } else if(27 == var2) {
