...
public class Class526_Sub21_Sub19 extends Class526_Sub21 {
   ...
   int method10732(RSByteBuffer var1, byte var2) {
      ...
      this.anInt11865 = var1.readUnsignedShort() * -891213711;
      this.anInt11869 = var1.readUnsignedShort() * -286211077;
      this.anInt11864 = var1.readUnsignedShort() * -1971615597;
      this.anInt11862 = var1.readUnsignedShort() * -195609411;
      this.anInt11857 = var1.readUnsignedShort() * 951838205;
      this.anInt11867 = var1.readUnsignedShort() * -401909401;
      ...
      if(var3 != Class508.aClass508_5705 && var3 != Class508.aClass508_6309) {
         if(var3 == Class508.aClass508_5709) {
            ...
            case 4:
               ...
               this.anIntArray11860[var2] = var1.readInt();
            }
