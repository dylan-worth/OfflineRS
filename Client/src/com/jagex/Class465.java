      ...
      if(var3 >= 0 && var3 < -1225795677 * this.anInt5244 && var4 >= 0 && var4 < -1769380583 * this.anInt5245) {
         ...
         if(0 != (var12 & 1)) {
            if(var10) {
               ...
               this.aShortArrayArrayArray5253[var2][var3][var4] = (short)var1.readSmart();
         ...
         if((var12 & 2) != 0) {
            if(!this.aBool5246 && !var10) {
               this.aClass470_5235.aByteArrayArrayArray5356[var2][var3][var4] = var1.readByte();
            } else {
               var1.pos += 801976415;
            }
         }
         ...
         if(0 != (var12 & 4)) {
            if(var10) {
               ...
               this.aShortArrayArrayArray5275[var2][var3][var4] = (short)var1.readSmart();
            }
         }
