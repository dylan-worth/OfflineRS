...
public class Class181 {
   ...
   public static Class173[] method2683(byte[] var0) {
      ...
      if(var3 == 0) {
         ...
         int var19 = var1.readUnsignedShort();
         var8 = (var1.readUnsignedByte(1802449446) & 255) + 1;

         for(var9 = 0; var9 < var4; ++var9) {
            var18[var9].anInt9853 = var1.readUnsignedShort();
         }

         for(var9 = 0; var9 < var4; ++var9) {
            var18[var9].anInt9855 = var1.readUnsignedShort();
         }

         for(var9 = 0; var9 < var4; ++var9) {
            var18[var9].anInt9851 = var1.readUnsignedShort();
         }

         for(var9 = 0; var9 < var4; ++var9) {
            var18[var9].anInt9852 = var1.readUnsignedShort();
         }
            ...
            if((var13 & 2) == 0) {
               ...
               if((var13 & 1) == 0) {
                  for(var23 = 0; var23 < var12; ++var23) {
                     var21.aByteArray9858[var23] = var1.readByte();
                  }
               } else {
                  for(var23 = 0; var23 < var21.anInt9851; ++var23) {
                     for(var15 = 0; var15 < var21.anInt9852; ++var15) {
                        var21.aByteArray9858[var23 + var15 * var21.anInt9851] = var1.readByte();
                     }
                  }
               }
            } else {
               ...
               if((var13 & 1) == 0) {
                  for(var15 = 0; var15 < var12; ++var15) {
                     var21.aByteArray9858[var15] = var1.readByte();
                  }

                  for(var15 = 0; var15 < var12; ++var15) {
                     byte var16 = var21.aByteArray9859[var15] = var1.readByte();
                     var14 |= var16 != -1;
                  }
               } else {
                  int var24;
                  for(var15 = 0; var15 < var21.anInt9851; ++var15) {
                     for(var24 = 0; var24 < var21.anInt9852; ++var24) {
                        var21.aByteArray9858[var15 + var24 * var21.anInt9851] = var1.readByte();
                     }
                  }

                  for(var15 = 0; var15 < var21.anInt9851; ++var15) {
                     for(var24 = 0; var24 < var21.anInt9852; ++var24) {
                        byte var17 = var21.aByteArray9859[var15 + var24 * var21.anInt9851] = var1.readByte();
                        var14 |= var17 != -1;
                     }
                  }
               }
