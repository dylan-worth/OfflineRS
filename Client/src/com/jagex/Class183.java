      ...
      try {
         ...
         for(var10 = 0; var10 < var6; ++var10) {
            ...
            if(var12 > 0) {
               ...
               if(var5 >= 2 && var11 == 7) {
                  if((var12 & 1) != 0) {
                     aShortArray2114[var7] = (short)var4.readUnsignedSmart();
                     var4.readUnsignedSmart();
                  } else {
                     aShortArray2114[var7] = var13;
                  }

                  if((var12 & 2) != 0) {
                     aShortArray2099[var7] = (short)var4.readUnsignedSmart();
                     var4.readUnsignedSmart();
                  } else {
                  ...
                  if((var12 & 4) != 0) {
                     aShortArray2097[var7] = (short)var4.readUnsignedSmart();
                     var4.readUnsignedSmart();
                  } else {
