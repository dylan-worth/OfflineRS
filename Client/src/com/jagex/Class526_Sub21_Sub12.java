      ...
      if(1 == var2) {
         ...
         if(var2 == 2) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.anIntArray11807[var5] = var1.readUnsignedShort();
            }
         } else if(3 == var2) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               ...
               if(null != var7) {
                  ...
                  for(int var8 = 0; var8 < var7.anInt8200 * 250805173; ++var8) {
                     this.anIntArrayArray11811[var5][var8] = var1.readUnsignedShort();
                  }
               }
            }
         } else if(var2 == 4) {
      ...
      if(1 == var2) {
         ...
         if(var2 == 2) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.anIntArray11807[var4] = var1.readUnsignedShort();
            }
         } else if(3 == var2) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               ...
               if(null != var6) {
                  ...
                  for(int var7 = 0; var7 < var6.anInt8200 * 250805173; ++var7) {
                     this.anIntArrayArray11811[var4][var7] = var1.readUnsignedShort();
                  }
               }
            }
         } else if(var2 == 4) {
