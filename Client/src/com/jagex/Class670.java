...
public class Class670 implements Interface12 {
   ...
   void method7971(RSByteBuffer var1, int var2) {
      if(1 == var2) {
         this.anInt8539 = var1.readBigSmart() * 1945850433;
      } else if(var2 == 2) {
         this.anInt8550 = var1.readBigSmart() * -913880409;
      } else if(4 == var2) {
         this.anInt8547 = var1.readUnsignedShort() * 680916131;
      } else if(var2 == 5) {
         this.anInt8549 = var1.readUnsignedShort() * -1508860237;
      } else if(var2 == 6) {
         this.anInt8551 = var1.readUnsignedShort() * -1174411885;
      } else if(7 == var2) {
         ...
         this.aByte8553 = 3;
         this.anInt8536 = var1.readUnsignedShort() * 1433859719;
      } else if(var2 == 16) {
         this.aByte8553 = 3;
         this.anInt8536 = var1.readInt() * 1433859719;
      } else {
         int var3;
         int var4;
         if(var2 == 40) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.aShortArray8548[var4] = (short)var1.readUnsignedShort();
               this.aShortArray8542[var4] = (short)var1.readUnsignedShort();
            }
         } else if(var2 == 41) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.aShortArray8543[var4] = (short)var1.readUnsignedShort();
               this.aShortArray8544[var4] = (short)var1.readUnsignedShort();
            }
         } else {
            int var5;
            int var6;
      ...
      if(1 == var2) {
         ...
         if(var2 == 40) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.aShortArray8548[var5] = (short)var1.readUnsignedShort();
               this.aShortArray8542[var5] = (short)var1.readUnsignedShort();
            }
         } else if(var2 == 41) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.aShortArray8543[var5] = (short)var1.readUnsignedShort();
               this.aShortArray8544[var5] = (short)var1.readUnsignedShort();
            }
         } else {
            int var6;
            int var7;
