...
public class Class391 {
   ...
   void method4778(RSByteBuffer var1, int var2, int var3) {
      if(var2 == 1) {
         this.anInt4079 = var1.readUnsignedShort() * 2022155427;
      } else if(2 == var2) {
         var1.readUnsignedByte(829322838);
      } else if(var2 == 3) {
         this.anInt4080 = var1.readInt() * -926384961;
         this.anInt4081 = var1.readInt() * 2065723945;
         this.anInt4083 = var1.readInt() * -1638562013;
      } else if(4 == var2) {
         this.anInt4082 = var1.readUnsignedByte(2052579156) * 1751664971;
         this.anInt4076 = var1.readInt() * -931541147;
      } else if(var2 == 6) {
