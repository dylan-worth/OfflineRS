...
public class Class556 {
   ...
   public Class556(Class174 var1, int var2, RSByteBuffer var3, int var4) {
      ...
      int var5 = var3.readUnsignedShort() << var4;
      int var6 = var3.readUnsignedShort() << var4;
      int var7 = var3.readUnsignedShort() << var4;
      ...
      for(var10 = 0; var10 < this.aShortArray7485.length; ++var10) {
         short var11 = (short)var3.readUnsignedShort();
         int var12 = var11 >>> 8;
         int var13 = var11 & 255;
         if(var12 >= var9) {
            var12 = var9 - 1;
      ...
      var10 = null != Class661.anIntArray8516?Class661.anIntArray8516[var3.readUnsignedShort()]:Class87.anIntArray855[Class616.method7307(var3.readUnsignedShort(), 1141260659) & '\uffff'];
      ...
      this.anInt7500 = var3.readShort() * 1430623681;
