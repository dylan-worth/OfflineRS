...
public class Class348 {
   ...
   void method4501(RSByteBuffer var1, int var2) {
      ...
      if(var3 >= 1 && var3 <= 6) {
         ...
         this.anInt3635 = var1.readInt() * -911768907;
         this.anInt3625 = var1.readInt() * 404186549;
         if(var3 <= 3 && 0 != this.anInt3625 * 791683229) {
            this.anInt3625 += 483038752;
         }

         this.anInt3631 = var1.readUnsignedShort() * -442229989;
         ...
         this.aByte3627 = var1.readByte();
         this.aByte3633 = var1.readByte();
         this.aByte3629 = var1.readByte();
         this.aByte3636 = var1.readByte();
         int var5;
         if(-1488926957 * this.anInt3631 > 0) {
            ...
            for(var5 = 0; var5 < -1488926957 * this.anInt3631; ++var5) {
               ...
               this.aByteArray3643[var5] = var1.readByte();
               if(var3 >= 2) {
                  this.anIntArray3648[var5] = var1.readInt();
               }

               if(var3 >= 5) {
                  this.anIntArray3630[var5] = var1.readUnsignedShort();
               } else {
      ...
      if(var2 >= 1 && var2 <= 6) {
         ...
         if(-1488926957 * this.anInt3631 > 0) {
            ...
            for(var4 = 0; var4 < -1488926957 * this.anInt3631; ++var4) {
               ...
               this.aByteArray3643[var4] = var1.readByte();
               if(var2 >= 2) {
                  this.anIntArray3648[var4] = var1.readInt();
               }

               if(var2 >= 5) {
                  this.anIntArray3630[var4] = var1.readUnsignedShort();
               } else {
