...
public class Class462 {
   ...
   void method5472(byte[] var1, int var2) {
      ...
      if(var4 >= 5 && var4 <= 7) {
         if(var4 >= 6) {
            this.anInt5210 = var3.readInt() * -1162485961;
         } else {
            this.anInt5210 = 0;
         }
         ...
         if(var4 >= 7) {
            ...
            this.anInt5211 = var3.readUnsignedShort() * 1513897037;
         }
         ...
         if(var4 >= 7) {
            ...
            for(var12 = 0; var12 < 497900677 * this.anInt5211; ++var12) {
               this.anIntArray5221[var12] = var10 += var3.readUnsignedShort();
               if(this.anIntArray5221[var12] > var11) {
                  var11 = this.anIntArray5221[var12];
               }
            }
         ...
         if(var6) {
            ...
            for(var12 = 0; var12 < this.anInt5211 * 497900677; ++var12) {
               this.anIntArray5213[this.anIntArray5221[var12]] = var3.readInt();
            }
         ...
         for(var12 = 0; var12 < 497900677 * this.anInt5211; ++var12) {
            this.anIntArray5224[this.anIntArray5221[var12]] = var3.readInt();
         }

         if(var9) {
            for(var12 = 0; var12 < this.anInt5211 * 497900677; ++var12) {
               this.anIntArray5225[var12] = var3.readInt();
            }
         }
         ...
         if(var8) {
            ...
            for(var12 = 0; var12 < this.anInt5211 * 497900677; ++var12) {
               this.anIntArray5220[this.anIntArray5221[var12]] = var3.readInt();
               this.anIntArray5207[this.anIntArray5221[var12]] = var3.readInt();
            }
         }

         for(var12 = 0; var12 < 497900677 * this.anInt5211; ++var12) {
            this.anIntArray5219[this.anIntArray5221[var12]] = var3.readInt();
         }
         ...
         if(var4 >= 7) {
            ...
            for(var12 = 0; var12 < this.anInt5211 * 497900677; ++var12) {
               this.anIntArray5222[this.anIntArray5221[var12]] = var3.readUnsignedShort();
            }
            ...
            for(var12 = 0; var12 < this.anInt5211 * 497900677; ++var12) {
               ...
               for(var16 = 0; var16 < var14; ++var16) {
                  var17 = this.anIntArrayArray5223[var18][var16] = var10 += var3.readUnsignedShort();
                  if(var17 > var15) {
                     var15 = var17;
                  }
               }
         ...
         if(var6) {
            ...
            for(var12 = 0; var12 < this.anInt5211 * 497900677; ++var12) {
               ...
               for(var15 = 0; var15 < var14; ++var15) {
                  ...
                  this.anIntArrayArray5218[var18][var16] = var3.readInt();
               }
