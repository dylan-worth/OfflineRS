...
public class Class199_Sub20 extends Class199 {
   ...
   Class199_Sub20(RSByteBuffer var1) {
      super(var1);
      this.anInt9970 = var1.readUnsignedShort() * -340739891;
      this.anInt9967 = var1.readUnsignedShort() * -1796912369;
      this.aString9968 = var1.readString(-20295985);
      this.anInt9969 = var1.readInt() * 1820068345;
      this.anInt9966 = var1.readUnsignedShort() * 1656396575;
   }
