   ...
   void method2899(RSByteBuffer var1, int var2) {
      ...
      if(1 == var2) {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            this.anIntArray2226[var4] = var1.readUnsignedShort();
         }

         this.anIntArray2232 = new int[var3];

         for(var4 = 0; var4 < var3; ++var4) {
            this.anIntArray2232[var4] = var1.readUnsignedShort();
         }

         for(var4 = 0; var4 < var3; ++var4) {
            this.anIntArray2232[var4] += var1.readUnsignedShort() << 16;
         }
      } else if(2 == var2) {
         this.anInt2243 = var1.readUnsignedShort() * 328862319;
      } else if(var2 == 5) {
         this.anInt2234 = var1.readUnsignedByte(56710859) * -607827841;
      } else if(6 == var2) {
         this.anInt2230 = var1.readUnsignedShort() * 76949825;
      } else if(var2 == 7) {
         this.anInt2240 = var1.readUnsignedShort() * 333212185;
      } else if(8 == var2) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               ...
               if(var5 > 0) {
                  ...
                  for(var6 = 1; var6 < var5; ++var6) {
                     this.anIntArrayArray2228[var4][var6] = var1.readUnsignedShort();
                  }
               }
            }
         } else if(14 == var2) {
            ...
            if(var2 != 19 && var2 != 119) {
               if(20 != var2 && var2 != 120) {
                  if(22 == var2) {
                     ...
                     this.anInt2229 = var1.readUnsignedShort() * 45577045;
                  ...
                  this.anIntArray2242[var3] = var1.readUnsignedShort();
                  this.anIntArray2233[var3] = var1.readUnsignedShort();
               }
            } else {
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            this.anIntArray2225[var4] = var1.readUnsignedShort();
         }

         for(var4 = 0; var4 < var3; ++var4) {
            this.anIntArray2225[var4] += var1.readUnsignedShort() << 16;
         }
      }
   ...
   void method2905(RSByteBuffer var1, int var2, int var3) {
      ...
      if(1 == var2) {
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.anIntArray2226[var5] = var1.readUnsignedShort();
         }

         this.anIntArray2232 = new int[var4];

         for(var5 = 0; var5 < var4; ++var5) {
            this.anIntArray2232[var5] = var1.readUnsignedShort();
         }

         for(var5 = 0; var5 < var4; ++var5) {
            this.anIntArray2232[var5] += var1.readUnsignedShort() << 16;
         }
      } else if(2 == var2) {
         this.anInt2243 = var1.readUnsignedShort() * 328862319;
      } else if(var2 == 5) {
         ...
         if(var2 == 13) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               ...
               if(var6 > 0) {
                  ...
                  for(var7 = 1; var7 < var6; ++var7) {
                     this.anIntArrayArray2228[var5][var7] = var1.readUnsignedShort();
                  }
               }
            }
         } else if(14 == var2) {
            ...
            if(var2 != 19 && var2 != 119) {
               if(20 != var2 && var2 != 120) {
                  ...
                  this.anIntArray2242[var4] = var1.readUnsignedShort();
                  this.anIntArray2233[var4] = var1.readUnsignedShort();
               }
            } else {
               if(this.anIntArray2241 == null) {
                  this.anIntArray2241 = new int[this.anIntArrayArray2228.length];
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.anIntArray2225[var5] = var1.readUnsignedShort();
         }

         for(var5 = 0; var5 < var4; ++var5) {
            this.anIntArray2225[var5] += var1.readUnsignedShort() << 16;
         }
      }
