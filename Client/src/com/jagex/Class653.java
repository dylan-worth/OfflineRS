...
public class Class653 implements Interface12, Interface5 {
	...
	void method7786(RSByteBuffer class526_sub36, int i, byte i_2_) {
		if (i == 1)
			...
			anInt8468 = class526_sub36.readUnsignedShort() * 2093160633;
			...
			if (9 == i)
				anInt8471 = ((class526_sub36.readUnsignedShort() << 2) * -915092721);
			else if (10 == i)
				aBool8469 = false;
			else if (11 == i)
				...
				anInt8476 = class526_sub36.readUnsignedShort() * -2071003061;
			else if (21 == i)
				anInt8479 = class526_sub36.readUnsignedByte(-531022689) * -1084645003;
			else if (i == 22)
				anInt8480 = class526_sub36.readUnsignedShort() * 1257680805;
		}
	}
