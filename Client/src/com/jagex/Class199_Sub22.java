...
public class Class199_Sub22 extends Class199 {
   ...
   Class199_Sub22(RSByteBuffer var1) {
      super(var1);
      this.anInt9975 = var1.readUnsignedShort() * 563985113;
      int var2 = var1.readUnsignedByte(206199637);
      if(0 != (var2 & 1)) {
         this.anInt9977 = var1.readUnsignedShort() * 1741139795;
         this.anInt9976 = var1.readUnsignedShort() * -1532123531;
      } else {
      ...
      if(0 != (var2 & 2)) {
         this.anInt9978 = var1.readUnsignedShort() * 2065690243;
         this.anInt9974 = var1.readUnsignedShort() * 897765189;
      } else {
