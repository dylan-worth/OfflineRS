...
class Class208 implements Interface56 {
   ...
   static final void decodeNPCMask(int var0) {
      ...
      for(int var2 = 0; var2 < 1544015143 * client.anInt11065; ++var2) {
         ...
         if(0 != (var5 & 134217728)) {
            npc.aByte11928 = var1.read128Byte();
            npc.aByte11929 = var1.read128Byte();
            npc.aByte11899 = var1.readByte();
            npc.aByte11893 = (byte)var1.readByteC();
            npc.anInt11926 = (client.anInt11012 + var1.readUnsignedShort128((short)15849)) * -1462749463;
            npc.anInt11933 = (client.anInt11012 + var1.readUnsignedShort()) * 1238611391;
         }
         ...
         if(0 != (var5 & 128)) {
            ...
            if(var6 > 0) {
               for(var7 = 0; var7 < var6; ++var7) {
                  ...
                  if(var8 == 32767) {
                     ...
                     var9 = var1.readSmart();
                     var22 = var1.readSmart();
                  } else if(var8 != 32766) {
                     var10 = var1.readSmart();
                  } else {
                     var8 = -1;
                     var10 = var1.readUnsignedByte128();
                  }
            ...
            if(var7 > 0) {
               for(var8 = 0; var8 < var7; ++var8) {
                  ...
                  if(var10 != 32767) {
                     var22 = var1.readSmart();
                     var12 = var1.readByteC();
                     var13 = var10 > 0?var1.readUnsignedByte128():var12;
         ...
         if((var5 & 1) != 0) {
            ...
            npc.method10981((NPCDef)Class76.loader.method89(var1.readBigSmart(), -1723408191), 0 == (var5 & 8388608), (var5 & 131072) == 0, true, 1302222279);
         ...
         if((var5 & 64) != 0) {
            npc.anInt12192 = var1.readUnsignedShort() * 1172692015;
         ...
         if(0 != (var5 & 2048)) {
            npc.anInt12191 = var1.readUnsignedShort() * -851363225;
         ...
         if((var5 & 16) != 0) {
            npc.anInt11911 = var1.readUnsignedShort() * -790295043;
         ...
         if((var5 & 262144) != 0) {
            ...
            for(var9 = 0; var9 < 8; ++var9) {
               if(0 != (var6 & 1 << var9)) {
                  var25[var9] = var1.readBigSmart();
                  var32[var9] = (short)var1.readDecoratedSmart();
               } else {
                  var25[var9] = -1;
                  var32[var9] = -1;
               }
         ...
         if((var5 & 8192) != 0) {
            npc.anInt11912 = var1.read128Byte() * -1923326237;
            npc.anInt11919 = var1.read128Byte() * 1573028629;
            npc.anInt11920 = var1.read128Byte() * -1475013205;
            npc.anInt11954 = var1.readByte() * 193059349;
            npc.anInt11921 = var1.readByteC(-2087725885) * -1199325289;
            npc.anInt11922 = var1.read128Byte() * -1820207517;
         ...
         if(0 != (var5 & 536870912)) {
            npc.aBool11895 = var1.readUnsignedByte128() == 1;
         }
         ...
         if(0 != (var5 & 4096)) {
            ...
            for(var10 = 0; var10 < var6; ++var10) {
               var22 = var1.readBigSmart();
               var25[var10] = var22;
               var26[var10] = var1.readUnsignedByte(630567826);
               var35[var10] = var1.readUnsignedShort();
            }
