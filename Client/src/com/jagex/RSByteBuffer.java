...
public class RSByteBuffer extends Class526 {
	...
	public long method9631(int i) {
		...
		long l_29_ = (long) readInt() & 0xffffffffL;
		return (l << 32) + l_29_;
	}

	public long method9632(int i) {
		long l = (long) readUnsignedShort() & 0xffffffffL;
		long l_30_ = (long) readInt() & 0xffffffffL;
		return (l << 32) + l_30_;
	}
	...
	public long method9663(int i) {
		...
		long l_83_ = (long) readInt() & 0xffffffffL;
		return (l << 32) + l_83_;
	}
	...
	public int method9683(byte i) {
		int i_93_ = 0;
		int i_94_;
		for (i_94_ = readSmart(); i_94_ == 32767; i_94_ = readSmart())
			i_93_ += 32767;
		i_93_ += i_94_;
		return i_93_;
	}
	...
	public long method9699() {
		long l = (long) readInt() & 0xffffffffL;
		long l_104_ = (long) readInt() & 0xffffffffL;
		return (l << 32) + l_104_;
	}
	...
	public int method9707() {
		int i = 0;
		int i_105_;
		for (i_105_ = readSmart(); i_105_ == 32767; i_105_ = readSmart())
			i += 32767;
		i += i_105_;
		return i;
	}
	...
	public long method9721() {
		long l = (long) readInt() & 0xffffffffL;
		long l_121_ = (long) readInt() & 0xffffffffL;
		return (l << 32) + l_121_;
	}
