...
public class Class557 implements Interface12 {
   ...
   void method6706(RSByteBuffer var1, int var2, int var3) {
      if(var2 == 1) {
         ...
         this.anInt7523 = var1.readUnsignedShort() * 524522097;
      } else if(var2 == 6) {
         var1.readUnsignedByte(-866819159);
      } else if(7 == var2) {
         this.anInt7521 = var1.readBigSmart() * -1185497767;
      } else if(var2 == 8) {
         this.anInt7525 = var1.readBigSmart() * -506842161;
      } else if(9 == var2) {
         this.anInt7527 = var1.readBigSmart() * -332936955;
      } else if(10 == var2) {
         this.anInt7524 = var1.readBigSmart() * -1034629875;
      } else if(11 == var2) {
         this.anInt7526 = var1.readUnsignedShort() * 1081898997;
      } else if(12 == var2) {
         this.anInt7528 = var1.readBigSmart() * 1636617413;
      } else if(13 == var2) {
         this.anInt7529 = var1.readBigSmart() * -989457219;
      }
