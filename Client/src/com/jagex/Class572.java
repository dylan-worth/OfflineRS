...
public class Class572 implements Interface12 {
   ...
   void method6897(RSByteBuffer var1, int var2, int var3) {
      if(1 == var2) {
         this.anInt7667 = var1.readBigSmart() * -474758487;
      } else if(var2 == 2) {
         this.anInt7668 = var1.read24BitInt(742041327) * 781830799;
         this.aBool7676 = true;
      } else if(3 == var2) {
         this.anInt7670 = var1.readBigSmart() * 516923433;
      } else if(var2 == 4) {
         this.anInt7672 = var1.readBigSmart() * 240868153;
      } else if(var2 == 5) {
         this.anInt7680 = var1.readBigSmart() * 2053729221;
      } else if(6 == var2) {
         this.anInt7673 = var1.readBigSmart() * 200565215;
      } else if(7 == var2) {
         this.anInt7674 = var1.readShort() * 1877771469;
      } else if(var2 == 8) {
         this.aString7677 = var1.method9637(-1495866034);
      } else if(9 == var2) {
         this.anInt7659 = var1.readUnsignedShort() * -2090684443;
      } else if(10 == var2) {
         this.anInt7675 = var1.readShort() * -1391672435;
      } else if(var2 == 11) {
         this.anInt7661 = 0;
      } else if(var2 == 12) {
         this.anInt7678 = var1.readUnsignedByte(-375880016) * -1285170025;
      } else if(13 == var2) {
         this.anInt7679 = var1.readShort() * -488836807;
      } else if(var2 == 14) {
         this.anInt7661 = var1.readUnsignedShort() * 1781610977;
      } else if(16 == var2) {
         this.anInt7684 = var1.readShort() * 1583251245;
         this.anInt7681 = var1.readShort() * 1240812145;
      } else if(17 != var2 && 18 != var2) {
         if(var2 == 19) {
            this.anInt7669 = var1.readUnsignedShort() * -470199233;
         } else if(20 == var2) {
            this.anInt7686 = var1.readUnsignedShort() * 275785829;
         }
      } else {
         this.anInt7685 = var1.readUnsignedShort() * -250037475;
         if('\uffff' == this.anInt7685 * 2113920821) {
            this.anInt7685 = 250037475;
         }

         this.anInt7671 = var1.readUnsignedShort() * 2117352017;
         ...
         for(int var6 = 0; var6 <= var5; ++var6) {
            this.anIntArray7682[var6] = var1.readUnsignedShort();
   ...
   void method6906(RSByteBuffer var1, int var2) {
      if(1 == var2) {
         ...
         for(int var5 = 0; var5 <= var4; ++var5) {
            this.anIntArray7682[var5] = var1.readUnsignedShort();
