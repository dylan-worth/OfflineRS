...
public class Class639_Sub1_Sub2_Sub1_Sub1 extends Class639_Sub1_Sub2_Sub1 {
	...
	public final void decodeAppearance(RSByteBuffer class526_sub36, int i) {
		...
		if (bool_4_)
			...
			aString12170 = null;
		aClass624_12183 = ((Class624) Class561.findIdentifiable(Class624.method7418((byte) 68), class526_sub36.readByte(), (byte) -123));
		...
		if (bool) {
			anInt12171 = class526_sub36.readUnsignedShort() * -1415921091;
		...
		if (0 != anInt12179 * -1469591895) {
			...
			anInt12160 = class526_sub36.readUnsignedShort() * 364958771;
			anInt12176 = class526_sub36.readUnsignedShort() * -555202607;
			anInt12177 = class526_sub36.readUnsignedShort() * 46854899;
			anInt12178 = class526_sub36.readUnsignedShort() * -368096955;
	...
	public void method10966(RSByteBuffer class526_sub36, byte i) {
		...
		for (int i_12_ = 0; i_12_ < anIntArray12166.length; i_12_++) {
			if (0 != (i_11_ & 1 << i_12_)) {
				...
				int i_14_ = class526_sub36.readUnsignedShort();
	...
	public void method10976(RSByteBuffer class526_sub36, byte i, byte i_97_) {
			...
			if (1 != Class710.aClass620_8851.anIntArray8123[i_99_]) {
				...
				if (0 == i_100_)
					...
					if (0 == i_99_ && i_102_ == 65535) {
						i_98_ = class526_sub36.readBigSmart();
		...
		if (i_98_ == -1) {
			int i_104_ = class526_sub36.readUnsignedShort();
			int i_105_ = 0;
		...
		anInt12164 = class526_sub36.readUnsignedShort() * -1224283193;
