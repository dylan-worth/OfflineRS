...
public class Class303 implements Interface12, Interface5 {
   ...
   void method3999(RSByteBuffer var1, int var2, int var3) {
      if(var2 == 1) {
         this.anInt3263 = var1.readUnsignedShort() * 1174784299;
      } else if(var2 == 2) {
         this.aBool3262 = true;
      } else if(3 == var2) {
         this.anInt3264 = var1.readShort() * 1800450507;
         this.anInt3265 = var1.readShort() * -1937229493;
         this.anInt3266 = var1.readShort() * 16545533;
      } else if(var2 == 4) {
         this.anInt3270 = var1.readUnsignedByte(-722174213) * 1977942325;
      } else if(5 == var2) {
         this.anInt3269 = var1.readBigSmart() * -1741102283;
      } else if(var2 == 6) {
         this.anInt3268 = var1.read24BitInt(742041327) * 727707141;
      } else if(var2 == 7) {
         this.anInt3272 = var1.readShort() * -326855235;
         this.anInt3271 = var1.readShort() * 378263877;
         this.anInt3267 = var1.readShort() * -1465392723;
      }
