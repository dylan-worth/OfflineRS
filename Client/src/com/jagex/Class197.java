...
public class Class197 {
   ...
   static Class526_Sub21_Sub17 method2843(RSByteBuffer var0, int var1, int var2) {
      Class526_Sub21_Sub17 var3 = new Class526_Sub21_Sub17(var1, var0.readString(105189872), var0.readString(-407480638), var0.readInt(), var0.readInt(), var0.readUnsignedByte(1989618859) == 1, var0.readUnsignedByte(29485823), var0.readUnsignedByte(-1990236471));
      int var4 = var0.readUnsignedByte(1344654041);

      for(int var5 = 0; var5 < var4; ++var5) {
         var3.aClass702_11839.method8176(new Class526_Sub41(var0.readUnsignedByte(-755597712), var0.readUnsignedShort(), var0.readUnsignedShort(), var0.readUnsignedShort(), var0.readUnsignedShort(), var0.readUnsignedShort(), var0.readUnsignedShort(), var0.readUnsignedShort(), var0.readUnsignedShort()), -2061173333);
      }
