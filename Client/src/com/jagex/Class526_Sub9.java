...
public class Class526_Sub9 extends Class526 {
   ...
   void method9343(RSByteBuffer var1) {
      ...
      this.aByte10408 = var1.readByte();
      this.aByte10407 = var1.readByte();
      this.anInt10400 = var1.readUnsignedShort() * -1976692053;
      if(this.anInt10400 * 1763792899 > 0) {
         ...
         for(int var4 = 0; var4 < this.anInt10400 * 1763792899; ++var4) {
            ...
            var5.aByte3526 = var1.readByte();
            var5.anInt3527 = var1.readUnsignedShort() * -1445041571;
            if(var3 >= 3) {
   ...
   void method9347(RSByteBuffer var1, int var2) {
      ...
      if(this.anInt10400 * 1763792899 > 0) {
         ...
         for(int var5 = 0; var5 < this.anInt10400 * 1763792899; ++var5) {
            ...
            var6.aByte3526 = var1.readByte();
            var6.anInt3527 = var1.readUnsignedShort() * -1445041571;
            if(var4 >= 3) {
